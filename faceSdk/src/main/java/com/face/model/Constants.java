...
public class Constants {
    ...
    // 控制码中：分类
    public static class ControlCategory {
        public ControlCategory(byte category) {
            mCurentCategory = category;
        }

        public static boolean isValidCategory(byte category) {
            if ((0<category && category < 10) || category == 0xFF) return true;
            return false;
        }

        public byte mCurentCategory;
    ...
    public static class CommandCategory {
        public CommandCategory(byte category) {
            mCurrentCmdCategory = category;
        }

        public byte mCurrentCmdCategory;
